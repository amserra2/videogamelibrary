...
public final class EditGamePane extends HBox {
    ...
    public void createGameImageButton() {
        ...
        gameImageButton = new Button("Add New\nGame\nImage");
    ...
    public Game addCorrections() {
        ...
        if (platformComboBox.getValue() != null) {
            updateOldPlatform();
            File oldImage = new File("/Users/asia/Applications/VideoGameLibrary/LibraryProgramFiles/resources/images/games/" + game.getID()+ ".png"); //any location
            
            game.setPlatform(((String) platformComboBox.getValue()).trim());
            game.setID(newGameID());
            File newImage = new File("/Users/asia/Applications/VideoGameLibrary/LibraryProgramFiles/resources/images/games/" + game.getID()+ ".png"); //any location
